                             ...
                             />
                              ...
                              <br></br>
                               ...
                               <div style={{ display: "flex", justifyContent: "space-around" }}>
                                   ...
                                   <Button onClick={mostrarFormOpciones} type="submit" className="primary" variant="primary"  size="sm">Guardar</Button>
                ...
                <Card.Body>
                    ...
                    <Form onSubmit={onClickAceptarRespuestas} >
                        ...
                        <div style={{ display: "flex", justifyContent: "space-around" }}>
                            ...
                            <Button className="btnListoVolver" onClick={volverPasoDos}> 
                                Listo
                            </Button>
                        </div>
